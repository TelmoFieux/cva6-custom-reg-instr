...
#(
    ...
    localparam type scoreboard_entry_t = struct packed {
      ...
      logic [4:0] arch_rd; // architectural destination register. Usefull to update commit_rat
      logic [CVA6Cfg.VLEN-1:0] pc;  // PC of instruction
      logic [CVA6Cfg.TRANS_ID_BITS-1:0] trans_id; // this can potentially be simplified, we could index the scoreboard entry
      // with the transaction id in any case make the width more generic
      logic [CVA6Cfg.GlobalRsIdWidth-1:0] global_rs_id; // global reservation station id used to track instr age
  ...
  logic [CVA6Cfg.NrCommitPorts-1:0][4:0] commit_rd_i_commit;
  ...
  ex_stage #(
      ...
      .ld_we_i(ld_we_id_ex),
      .st_we_i(st_we_id_ex),
      .data_trans_id_i(data_trans_id_id_ex),
