...
module instr_tracer #(
  ...
  input logic [CVA6Cfg.NrWbPorts-1:0][CVA6Cfg.RegAddrWidth-1:0] waddr, // WB stage
  input logic [CVA6Cfg.NrWbPorts-1:0][63:0]        wdata,
  input logic [CVA6Cfg.NrWbPorts-1:0]              we_gpr,
  input logic [CVA6Cfg.NrWbPorts-1:0]              we_fpr,
